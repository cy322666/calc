...
class BlindSystemAmgClassicMono45Seeder extends Seeder
{
    public function run(): void
    {
        ...
        $system = \App\Models\Calculator\BlindSystem::updateOrCreate(
            ['code' => 'amg_classic_mono_45'],
            [
                'name' => 'AMG классика Mono 45 мм',
                'description' => null,
                'category' => 'roller',
            ]
        );
        ...
        $items = [
            ...
            ['position' => 2,  'name' => 'Труба 45 мм, усиленная (AMG)', 'note' => null],
            ['position' => 3,  'name' => 'Механизм управления: цепь 45, комплект', 'note' => null],
            ['position' => 4,  'name' => 'Пластина подкладочная для MONO/DOUBLE AMG', 'note' => null],
            ['position' => 5,  'name' => 'Крышка кронштейна 45', 'note' => null],
            ['position' => 6,  'name' => 'Лента уплотняющая 6 мм', 'note' => null],
            ['position' => 7,  'name' => 'Кронштейн соединительный 45', 'note' => null],
            ['position' => 8,  'name' => 'Лента уплотняющая 7 мм', 'note' => null],
